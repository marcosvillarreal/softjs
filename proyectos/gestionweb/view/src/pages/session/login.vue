  ...
  <q-page padding class="flex flex-center">
      ...
      <div class="form">
        <q-field
          ...
          label="Usuario"
          helper="Some helper">
          <q-input v-model="login.username" type="email" autofocus name="username"></q-input>
        </q-field>
        ...
        <q-field
          ...
          label="Contraseña"
          helper="Some helper">
          <q-input v-model="login.password" type="password" ></q-input>
        </q-field>

      </div>

      <div class="actions md-layout md-alignment-center-space-between">
        <q-btn color="primary" @click="auth">Log in</q-btn>
      </div>
