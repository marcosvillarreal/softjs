...
preventamobile.configuration = function () {
    ...
    // urlServerOptions = ["http://10.0.0.149:8084/preventamobile/"];
     urlServerOptions = ["http://gmsoftware.ddns.net:8084/preventamobile/","http://preventa.cloudapp.net:8889/", "http://preventa.cloudapp.net:8890/", "http://preventa.cloudapp.net:8891/"];
