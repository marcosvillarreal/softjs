...
// 
// jQuery Versions - 1.2.8, 1.3.2, 1.4.1, 1.4.2
...
(function( $, window, undefined ) {
	...
	$.event.special.swipe = {
		...
		durationThreshold: 100, // More time than this, and it isn't a swipe.
			...
			$.ajax({
				...
				error: function( xhr, textStatus, errorThrown ) {
					...
					if ( settings.showLoadMsg ) {
						...
						// hide after delay
						setTimeout( $.mobile.hidePageLoadingMsg, 500 );
					}
